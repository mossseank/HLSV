...
public:
	...
	inline const CompilerError& get_last_error() const { return _last_error; }
	// Gets if the compiler instance has a current error
	inline bool has_error() const { return _last_error.source != CompilerError::ES_NONE; }
